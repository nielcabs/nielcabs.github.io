...
<head>
    ...
    <link rel="shortcut icon" href="favicon.45a969d9.ico" type="image/x-icon">
    <link rel="icon" href="favicon.45a969d9.ico" type="image/x-icon">
    <link rel="stylesheet" href="app.c3ae3b9b.css">
    <script defer="" src="app.906fd9ad.js"></script>
    <title>J.CABS</title>
</head>
...
<body>
    ...
    <div class="navigation">
        <a class="navigation__connect" href="#"><strong>reach</strong> me</a>

        <div class="menu__container">
            <div class="menu">
                <input class="menu__checkbox" type="checkbox">
                <span class="menu__line1"></span>
                <span class="menu__line2"></span>
                <span class="menu__line3"></span>
            </div>
        ...
        <nav class="navigation__nav">
            <ul class="navigation__list">
                ...
                <li class="navigation__item"><a href="#" class="navigation__link">Commercial Work</a></li>
            </ul>
        </nav>
    ...
    <header class="header">
        <div class="header__bg translate layer" data-speed="0.25"></div>
        <h1 class="heading-primary translate header__title" data-speed="0.3">j.cabs</h1>
        <div class="header__rock translate layer"></div>
        <div class="header__bottom-fade"></div>
    </header>

    <aside class="social">
        <a href="http://www.facebook.com/nielcabo06" class="social__link">
    ...
    <main>
        ...
        <section class="section-about">
            ...
            <div class="section-about__row">
                ...
                <div class="section-about__col">
                    <h3 class="header-tertiary u-margin-bottom-smallest">I like to travel and take a picture.</h3>
                    <p class="paragraph">Together with my friends we explore different places. Adventures give us
                        pleasant memories, which we often bring back to the forefront of our minds for reminiscing.</p>

                    <h3 class="header-tertiary u-margin-top-small u-margin-bottom-smallest">There are no shortcuts to
                        any place worth going.</h3>
                    <p class="paragraph">Placing yourself in situations where things don’t always go as planned—such as
                        on an adventure trip—helps you learn to cope with the uncertainties in life. And there is no
                        shortage of those.</p>

                    <a href="#" class="btn-text u-margin-top-small">Learn more &rarr;</a>
                </div>

                <div class="section-about__col">
                    <div class="composition">
                        <img loading="lazy" src="group1.jpg" alt="Photo 1" class="composition__photo composition__photo--p1">
                        <img loading="lazy" src="group2.jpg" alt="Photo 2" class="composition__photo composition__photo--p2">
                        <img loading="lazy" src="group3.jpg" alt="Photo 3" class="composition__photo composition__photo--p3">
                    </div>
                </div>
        ...
        <section class="section-works">
            <h2 class="heading-secondary u-margin-bottom-medium u-text-center">
                works.
            </h2>
            <div class="grid-works">

                <div class="grid-works__box">
                    <img src="land.jpg" alt="">

                    <div class="grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>

                <div class="grid-works__box">
                    <img src="landscape-2.6d7f6a1f.jpg" alt="">
                    <div class="grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
                ...
                <div class="grid-works__box">
                    <img src="landscape-5.896cbb8b.jpg" alt="">
                    <div class="grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
                ...
                <div class="grid-works__box">
                    <img src="landscape-8.a722f0ce.jpg" alt="">
                    <div class="grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
            ...
            <br>
                    <h2 class="heading-secondary u-margin-bottom-medium u-text-center">Models</h2>

            <!-- ! -------------------------------------------------- -->
            <div class="sub-grid-works u-margin-top-medium">

                <div class="sub-grid-works__box">
                    <a href="nics.html">
                    <img loading="lazy" src="sample.jpg" alt="">
                </a>        
                    <div class="sub-grid-works__overlay">
                        <a href="nics.html">
                        <img src="viewer.a77d3f9c.png" alt="">
                        </a>
                        <center><p>Nicole Estrada</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="sample4.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                        <center><p>Mark Rainer Maglaqui</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="sample3.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                        <center><p>Sheyy Francisco</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="sample5.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                        <center><p>Jenebie Lucero</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="sample2.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                        <center><p>Jeaboy Luna</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="sample6.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                        <center><p>Erem Lopez</p></center>
                    </div>
                </div>

                <div class="sub-grid-works__box">
                    <img loading="lazy" src="landscape-4.aac97b5b.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
                ...
                <div class="sub-grid-works__box">
                    <img loading="lazy" src="landscape-6.491815c5.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
                ...
                <div class="sub-grid-works__box">
                    <img loading="lazy" src="landscape-8.a722f0ce.jpg" alt="">
                    <div class="sub-grid-works__overlay">
                        <img src="viewer.a77d3f9c.png" alt="">
                    </div>
                </div>
            ...
            <!--<a href="#" class="simple-btn u-margin-top-medium">View All &rarr;</a>-->
                    ...
                    <form action="#" class="form">
                        <div class="u-margin-bottom-small">
                            <h2 class="heading-secondary">
                                Papicture ka din ba? Email mo na ako!    
                            </h2>
                        </div>
                        ...
                        <div class="form__group">
                            <textarea class="form__msg" name="message" placeholder="Say hi!"></textarea>
                        </div>

                        <div class="form__group">
                            <button class="btn-text btn-text__submit" type="submit">Next step &rarr;</button>
                        </div>
    ...
    <footer>
        <a href="mailto:nielcabo06@gmail.com">nielcabo06@gmail.com</a>
        <p>&copy; 2021 Juniel Cabo</p>
    </footer>
